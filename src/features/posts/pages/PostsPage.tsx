      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 space-y-6">
        <div className="animate-fade-up flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="h-11 w-11 rounded-2xl bg-pink-100 text-pink-600 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-slate-500 mt-1 text-sm sm:text-base">
                {t('pages.posts.subtitle')}
              </p>
            </div>
          </div>
          <Link
            to="/posts/create"
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition-all shadow-sm hover:shadow-md hover:shadow-blue-600/20 text-sm font-medium active:scale-[0.98]"
          >
        ...
        >
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-2xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 shadow-sm text-sm"
          />
        </div>
        ...
        <div className="animate-fade-up" style={{ animationDelay: '120ms' }}>
          {loading ? (
            ...
            <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 shadow-sm">
              <div className="mx-auto h-14 w-14 rounded-2xl bg-pink-50 flex items-center justify-center mb-4">
                <Newspaper className="h-7 w-7 text-pink-400" />
              </div>
              <p className="text-slate-600 font-medium">{t('pages.posts.empty')}</p>
              <Link
                to="/posts/create"
                className="inline-flex mt-4 px-4 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition-colors"
              >
            ...
            <div className="space-y-4">
              {posts.map((post, index) => {
                ...
                return (
                  <article
                    key={post.id}
                    className="bg-white rounded-2xl border border-slate-200 hover:border-pink-200 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 overflow-hidden animate-fade-up"
                  ...
                  >
                    ...
                    <div className="p-5 flex flex-col">
                      ...
                      <span
                        className="mt-3 inline-flex items-center gap-1.5 text-sm text-slate-400"
